...
import { FiPieChart, FiCreditCard, FiStar, FiShoppingCart } from 'react-icons/fi';
import { BsBarChart, BsCurrencyDollar, BsShield, BsChatLeft } from 'react-icons/bs';
...
export const TotalEntrerPrimaryXAxis = {
  valueType: 'Category',
  majorGridLines: { width: 0 },
  title: 'Jours',
};

export const TotalEntrerPrimaryYAxis = {
  lineStyle: { width: 0 },
  majorTickLines: { width: 0 },
  minorTickLines: { width: 0 },
  labelFormat: '{value}',
  title: 'Total entrée voitures',
};
